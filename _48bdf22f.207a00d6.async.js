...
>
  ...
  `}));var m=()=>(0,t.jsx)(I.Skeleton.Node,{active:!0,className:x.skeletonWrapper,style:{width:"100%",height:"100%"},children:" "});e.s(["default",0,({items:e})=>{let{showDebug:I,setShowDebug:x}=a.default.use(p.default),[v,h]=(0,u.default)(!1),g=a.default.useMemo(()=>e.reduce((e,t)=>{let{previewerProps:a}=t,{debug:n}=a;return n&&!I?e:e.concat({...t,previewerProps:{...a,expand:v,debug:!1,originDebug:n}})},[]),[v,e,I]);return(0,t.jsxs)("div",{className:"demo-wrapper",children:[(0,t.jsx)(r.Global,{styles:r.css`
    ...
    font-family: monospace;
  `}));function C(){let[e]=(0,c.default)(T),{styles:a}=$();return[{title:e.token,key:"name",dataIndex:"name"},{title:e.description,key:"desc",dataIndex:"desc"},{title:e.type,key:"type",dataIndex:"type",render:(e,n)=>(0,t.jsx)("span",{className:a.codeSpan,children:n.type})},{title:e.value,key:"value",render:(e,a)=>"string"==typeof a.value&&(a.value.startsWith("#")||a.value.startsWith("rgb"))?(0,t.jsx)(b.default,{value:a.value,enablePopover:!0,children:a.value}):"string"==typeof a.value&&a.value.toLowerCase().trim().startsWith("cubic-bezier")?(0,t.jsx)(f,{value:a.value}):"string"!=typeof a.value?JSON.stringify(a.value):a.value}]}e.s(["default",0,({type:e})=>{let[,o]=(0,c.default)(T),r=C(),l=a.useMemo(()=>Object.entries(y.tokenMeta.global).filter(([,t])=>t.source===e).map(([e,t])=>({name:e,desc:"cn"===o?t.desc:t.descEn,type:t.type,value:j[e]})),[e,o]);return(0,t.jsx)(n.Table,{bordered:!0,rowKey:e=>e.name,dataSource:l,columns:r,pagination:!1})},"useColumns",0,C],632086)},417546,e=>{"use strict";var t=e.i(418031),a=e.i(353250);let n=t.default,o=a.default;e.s(["tokenData",0,o,"tokenMeta",0,n])},779105,e=>{"use strict";e.s(["texts",0,[{value:"需要强化某个容器的视觉关注度，但又不希望引入业务状态语义时。",paraId:0,tocIndex:0},{value:"适合登录面板、推荐卡片、AI 模块、重点 CTA 区域等场景。",paraId:0,tocIndex:0},{value:"它是装饰性效果，不应替代焦点态、校验态或业务状态边框。",paraId:0,tocIndex:0},{value:"通用属性参考：",paraId:1,tocIndex:12},{value:"通用属性",paraId:2,tocIndex:12},{value:"参数",paraId:3,tocIndex:13},{value:"说明",paraId:3,tocIndex:13},{value:"类型",paraId:3,tocIndex:13},{value:"默认值",paraId:3,tocIndex:13},{value:"版本",paraId:3,tocIndex:13},{value:"全局配置",paraId:4,tocIndex:13},{value:"children",paraId:3,tocIndex:13},{value:"装饰内容",paraId:3,tocIndex:13},{value:"ReactNode",paraId:3,tocIndex:13},{value:"-",paraId:3,tocIndex:13},{value:"6.4.0",paraId:3,tocIndex:13},{value:"×",paraId:3,tocIndex:13},{value:"color",paraId:3,tocIndex:13},{value:"流光颜色配置，支持单色字符串或渐变停靠点数组。",paraId:3,tocIndex:13},{value:"percent",paraId:3,tocIndex:13},{value:" 使用 ",paraId:3,tocIndex:13},{value:"0 ~ 100",paraId:3,tocIndex:13},{value:" 的输入区间，组件会在内部为尾部透明过渡预留空间",paraId:3,tocIndex:13},{value:"string | { color: string; percent: number }[]",paraId:3,tocIndex:13},{value:"-",paraId:3,tocIndex:13},{value:"6.4.0",paraId:3,tocIndex:13},{value:"×",paraId:3,tocIndex:13},{value:"count",paraId:3,tocIndex:13},{value:"流光数量",paraId:3,tocIndex:13},{value:"number",paraId:3,tocIndex:13},{value:"1",paraId:3,tocIndex:13},{value:"6.6.0",paraId:3,tocIndex:13},{value:"×",paraId:3,tocIndex:13},{value:"duration",paraId:3,tocIndex:13},{value:"流光完成一圈动画的时间，单位秒",paraId:3,tocIndex:13},{value:"number",paraId:3,tocIndex:13},{value:"6",paraId:3,tocIndex:13},{value:"6.5.0",paraId:3,tocIndex:13},{value:"×",paraId:3,tocIndex:13},{value:"lineWidth",paraId:3,tocIndex:13},{value:"流光线宽，数字类型按像素处理",paraId:3,tocIndex:13},{value:"number | string",paraId:3,tocIndex:13},{value:"1px",paraId:3,tocIndex:13},{value:"6.5.0",paraId:3,tocIndex:13},{value:"×",paraId:3,tocIndex:13},{value:"outset",paraId:3,tocIndex:13},{value:"流光层相对容器边缘的外扩距离，遇到裁剪容器时可设为 ",paraId:3,tocIndex:13},{value:"0",paraId:3,tocIndex:13},{value:"number | string",paraId:3,tocIndex:13},{value:"-",paraId:3,tocIndex:13},{value:"6.4.0",paraId:3,tocIndex:13},{value:"×",paraId:3,tocIndex:13},{value:"size",paraId:3,tocIndex:13},{value:"流光可见段的尺寸，数字类型按像素处理",paraId:3,tocIndex:13},{value:"number | string",paraId:3,tocIndex:13},{value:"100",paraId:3,tocIndex:13},{value:"6.5.0",paraId:3,tocIndex:13},{value:"×",paraId:3,tocIndex:13},{value:"BorderBeam",paraId:5,tocIndex:16},{value:" 会将流光视为装饰效果。当命中 ",paraId:5,tocIndex:16},{value:"prefers-reduced-motion: reduce",paraId:5,tocIndex:16},{value:" 时，组件会隐藏 beam 效果。",paraId:5,tocIndex:16},{value:"color",paraId:6},{value:"percent",paraId:6},{value:"percent",paraId:7,tocIndex:17},{value:" 表示渐变停靠点的输入位置，取值范围为 ",paraId:7,tocIndex:17},{value:"0 ~ 100",paraId:7,tocIndex:17},{value:"。组件会将这些停靠点映射到可见 beam 段内，并为尾部透明过渡保留空间，以保持流光尾迹连续可见。",paraId:7,tocIndex:17},{value:"BorderBeam",paraId:6},{value:"BorderBeam",paraId:8,tocIndex:18},{value:" 需要通过 ",paraId:8,tocIndex:18},{value:"children",paraId:8,tocIndex:18},{value:" 获取实际 DOM 节点，并将流光层插入到该节点中。请确保被包裹的内容是原生 DOM 元素，或是正确透传 ",paraId:8,tocIndex:18},{value:"ref",paraId:8,tocIndex:18},{value:" 到 DOM 的 React 组件，否则组件无法定位真实容器，也就无法渲染流光效果。",paraId:8,tocIndex:18},{value:"流光层使用 ",paraId:9,tocIndex:18},{value:"position: absolute",paraId:9,tocIndex:18},{value:" 定位，因此被索引到的 DOM 节点还需要提供定位上下文，通常可以为它设置 ",paraId:9,tocIndex:18},{value:"position: relative",paraId:9,tocIndex:18},{value:"。",paraId:9,tocIndex:18},{value:"BorderBeam",paraId:9,tocIndex:18},{value:" 不会主动检测或修正子节点的定位样式。",paraId:9,tocIndex:18},{value:"为保证性能，",paraId:10,tocIndex:18},{value:"children",paraId:10,tocIndex:18},{value:" 是否可以插入以及其定位信息会在初始化时判断，后续不会持续监听子节点结构或定位样式变化。",paraId:10,tocIndex:18},{value:"BorderBeam",paraId:11,tocIndex:19},{value:" 会在初始化时读取实际容器的计算后 ",paraId:11,tocIndex:19},{value:"border-radius",paraId:11,tocIndex:19},{value:"。这个能力更适合 ",paraId:11,tocIndex:19},{value:"Card",paraId:11,tocIndex:19},{value:" 这类单容器子节点场景；若子节点结构较复杂，建议直接把圆角写在实际容器根节点上，以获得更稳定的结果。",paraId:11,tocIndex:19},{value:"为保证性能，圆角计算完成后不会持续重新测量。后续由尺寸、祖先样式或子节点内部状态引起的圆角变化，不保证自动重新同步。动画轨迹在运行时可能会做内部平滑处理。",paraId:12,tocIndex:19},{value:"例如：",paraId:13,tocIndex:19},{value:"const radius = 24;\n\n<BorderBeam>\n  <Card style={{ borderRadius: radius }} />\n</BorderBeam>;\n",paraId:14,tocIndex:19}]])},504595,e=>{"use strict";var t=e.i(833663);e.s(["Table",()=>t.default])},48750,e=>{"use strict";var t=e.i(251062);e.s(["LinkOutlined",()=>t.default])},883376,e=>{"use strict";var t=e.i(513875);e.s(["QuestionCircleOutlined",()=>t.default])},686111,e=>{"use strict";var t=e.i(571246);e.s(["RightOutlined",()=>t.default])}]);